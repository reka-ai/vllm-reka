...
class YasaMMLMV2ForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    # Used by vLLM BitsAndBytes loader to align HF checkpoint tensor names
    # with this wrapper's module namespace for target-module matching.
    hf_to_vllm_mapper = WeightsMapper(
        orig_to_new_prefix={
            "model.language_model.": "language_model.model.",
            "model.vision_model.backbone.": "vision_model.",
